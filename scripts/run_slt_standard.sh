...
# slt/standard/functions/scalars/list_value.slt        -- Cast different decimal precision/scale to same in sig resolution
...
cargo test slt/standard -- \
      ...
      --skip slt/standard/functions/scalars/list_value.slt \
