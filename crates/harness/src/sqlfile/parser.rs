                ...
                match expected {
                    QueryExpect::Results {
                        ...
                        write!(
                            f,
                            "{}",
                            types.iter().map(|c| c.to_char()).collect::<String>()
                        )?;
...
impl ExpectedError {
    ...
    pub fn from_actual_error(reference: Option<&Self>, actual_err: &str) -> Self {
        ...
        let err_is_multiline = trimmed_err.lines().count() > 1;
...
impl Condition {
    ...
    pub(crate) fn should_skip<'a>(&'a self, labels: impl IntoIterator<Item = &'a str>) -> bool {
        match self {
            Condition::OnlyIf { label } => !labels.into_iter().any(|v| v == label.as_str()),
            Condition::SkipIf { label } => labels.into_iter().any(|v| v == label.as_str()),
        }
    }
}
...
pub fn parse_with_name(script: &str, name: impl Into<Arc<str>>) -> Result<Vec<Record>, ParseError> {
...
";
    ...
    fn test_include_glob() {
        let records = parse_file("../tests/slt/include/include_1.slt").unwrap();
        assert_eq!(15, records.len());
    }

    // #[test]
    // fn test_basic() {
    //     parse_roundtrip("../tests/slt/basic.slt")
    // }

    // #[test]
    // fn test_condition() {
    //     parse_roundtrip("../tests/slt/condition.slt")
    // }

    // #[test]
    // fn test_file_level_sort_mode() {
    //     parse_roundtrip("../tests/slt/file_level_sort_mode.slt")
    // }

    // #[test]
    // fn test_rowsort() {
    //     parse_roundtrip("../tests/slt/rowsort.slt")
    // }

    // #[test]
    // fn test_valuesort() {
    //     parse_roundtrip("../tests/slt/valuesort.slt")
    // }

    // #[test]
    // fn test_substitution() {
    //     parse_roundtrip("../tests/substitution/basic.slt")
    // }

    // #[test]
    // fn test_test_dir_escape() {
    //     parse_roundtrip("../tests/test_dir_escape/test_dir_escape.slt")
    // }

    // #[test]
    // fn test_validator() {
    //     parse_roundtrip("../tests/validator/validator.slt")
    // }

    // #[test]
    // fn test_custom_type() {
    //     parse_roundtrip("../tests/custom_type/custom_type.slt")
    // }

    // #[test]
    // fn test_system_command() {
    //     parse_roundtrip("../tests/system_command/system_command.slt")
    // }
...
";
        ...
        let error_kind = parse(script).unwrap_err().kind;
...
";
    ...
    //     assert_eq!(records, output_contents, "Mismatch in reparsed records");
    // }
