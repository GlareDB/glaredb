...
pub const FUNCTION_SET_ATANH: ScalarFunctionSet = ScalarFunctionSet {
    ...
    functions: &[
        RawScalarFunction::new(
            ...
            &UnaryInputNumericScalar::<PhysicalF16, AtanhOp>::new(&DataType::Float16),
        ),
        RawScalarFunction::new(
            &Signature::new(&[DataTypeId::Float32], DataTypeId::Float32),
            &UnaryInputNumericScalar::<PhysicalF32, AtanhOp>::new(&DataType::Float32),
        ),
        RawScalarFunction::new(
            &Signature::new(&[DataTypeId::Float64], DataTypeId::Float64),
            &UnaryInputNumericScalar::<PhysicalF64, AtanhOp>::new(&DataType::Float64),
        ),
    ],
};
...
impl UnaryInputNumericOperation for AtanhOp {
    fn execute_float<S>(
        input: &Array,
