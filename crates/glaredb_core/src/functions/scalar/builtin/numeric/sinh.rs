...
pub const FUNCTION_SET_SINH: ScalarFunctionSet = ScalarFunctionSet {
    ...
    functions: &[
        RawScalarFunction::new(
            ...
            &UnaryInputNumericScalar::<PhysicalF16, SinhOp>::new(&DataType::Float16),
        ),
        RawScalarFunction::new(
            &Signature::new(&[DataTypeId::Float32], DataTypeId::Float32),
            &UnaryInputNumericScalar::<PhysicalF32, SinhOp>::new(&DataType::Float32),
        ),
        RawScalarFunction::new(
...
impl UnaryInputNumericOperation for SinhOp {
    fn execute_float<S>(
        input: &Array,
