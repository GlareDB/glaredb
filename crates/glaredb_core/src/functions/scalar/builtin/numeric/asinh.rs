...
pub const FUNCTION_SET_ASINH: ScalarFunctionSet = ScalarFunctionSet {
    ...
    functions: &[
        RawScalarFunction::new(
            ...
            &UnaryInputNumericScalar::<PhysicalF16, AsinhOp>::new(&DataType::Float16),
        ),
        RawScalarFunction::new(
            &Signature::new(&[DataTypeId::Float32], DataTypeId::Float32),
            &UnaryInputNumericScalar::<PhysicalF32, AsinhOp>::new(&DataType::Float32),
        ),
        RawScalarFunction::new(
...
impl UnaryInputNumericOperation for AsinhOp {
    fn execute_float<S>(
        input: &Array,
