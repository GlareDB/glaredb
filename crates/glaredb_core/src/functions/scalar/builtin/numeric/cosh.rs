...
pub const FUNCTION_SET_COSH: ScalarFunctionSet = ScalarFunctionSet {
    ...
    functions: &[
        RawScalarFunction::new(
            ...
            &UnaryInputNumericScalar::<PhysicalF16, CoshOp>::new(&DataType::Float16),
        ),
        RawScalarFunction::new(
            &Signature::new(&[DataTypeId::Float32], DataTypeId::Float32),
            &UnaryInputNumericScalar::<PhysicalF32, CoshOp>::new(&DataType::Float32),
        ),
        RawScalarFunction::new(
...
impl UnaryInputNumericOperation for CoshOp {
    fn execute_float<S>(
        input: &Array,
