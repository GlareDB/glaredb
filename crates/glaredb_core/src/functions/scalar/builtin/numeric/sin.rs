...
pub const FUNCTION_SET_SIN: ScalarFunctionSet = ScalarFunctionSet {
    name: FnName::default("sin"),
    aliases: &[],
    doc: &[&Documentation {
        category: Category::Numeric,
        description: "Compute the sin of value.",
        arguments: &["float"],
    ...
    functions: &[
        RawScalarFunction::new(
            ...
            &UnaryInputNumericScalar::<PhysicalF16, SinOp>::new(DataType::FLOAT16),
        ),
        RawScalarFunction::new(
            &Signature::new(&[DataTypeId::Float32], DataTypeId::Float32),
            &UnaryInputNumericScalar::<PhysicalF32, SinOp>::new(DataType::FLOAT32),
        ),
        RawScalarFunction::new(
            &Signature::new(&[DataTypeId::Float64], DataTypeId::Float64),
            &UnaryInputNumericScalar::<PhysicalF64, SinOp>::new(DataType::FLOAT64),
        ),
    ],
};
