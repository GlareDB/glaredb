...
impl HashTable {
    ...
    fn find_or_create_groups(&mut self, groups: &[ArrayOld], hashes: &[u64]) -> Result<()> {
...
mod tests {
    ...
    #[test]
    fn insert_simple() {
        let groups = [ArrayOld::from_iter(["g1", "g2", "g1"])];
        let inputs = [ArrayOld::from_iter::<[i64; 3]>([1, 2, 3])];
    ...
    fn insert_chunk_append() {
        ...
        let groups2 = [ArrayOld::from_iter(["g1", "g2", "g3"])];
    ...
    fn insert_require_resize() {
        ...
        let groups = [ArrayOld::from_iter(0..17)];
        let inputs = [ArrayOld::from_iter(0_i64..17_i64)];
    ...
    fn insert_require_resize_more_than_double() {
        ...
        let groups = [ArrayOld::from_iter(0..33)];
        let inputs = [ArrayOld::from_iter(0_i64..33_i64)];
    ...
    fn merge_simple() {
        ...
        let groups2 = [ArrayOld::from_iter(["g3", "g2", "g1"])];
        let inputs2 = [ArrayOld::from_iter::<[i64; 3]>([1, 2, 3])];
    ...
    fn merge_non_empty_then_merge_empty() {
        ...
        let groups2 = [ArrayOld::from_iter(["g1", "g2"])];
        let inputs2 = [ArrayOld::from_iter::<[i64; 2]>([4, 5])];
        let hashes = vec![4, 5];
