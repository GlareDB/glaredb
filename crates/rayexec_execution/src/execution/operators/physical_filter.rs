...
impl ExecutableOperator for PhysicalFilter {
        ...
        let partition_states = (0..partitions)
            .map(|_| {
                Ok(PartitionState::Filter(FilterPartitionState {
                    ...
                    output: Array::new(&NopBufferManager, DataType::Boolean, batch_size)?,
    ...
    fn poll_execute(
        ...
        state.output.reset_for_write(&NopBufferManager)?;
        state
            .evaluator
...
mod tests {
    ...
    use crate::execution::operators::testutil::wrapper::OperatorWrapper;
