...
impl ScalarFunction for ListExtract {
    fn plan(
        ...
        let inner_datatype = match &datatypes[0] {
            DataTypeOld::List(meta) => meta.datatype.as_ref().clone(),
            other => {
