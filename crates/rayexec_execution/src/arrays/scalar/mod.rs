...
impl ScalarValue<'_> {
    ...
    pub fn as_array(&self, n: usize) -> Result<Array2> {
        let data: ArrayData = match self {
            Self::Null => return Ok(Array2::new_untyped_null_array(n)),
        ...
        let mut array = Array2::new_with_array_data(self.datatype(), data);
