...
impl<R: Runtime> TableFunction2 for ReadIceberg<R> {
    fn planner(&self) -> TableFunctionPlanner2 {
        TableFunctionPlanner2::Scan(self)
    }
}

impl<R: Runtime> ScanPlanner2 for ReadIceberg<R> {
    fn plan<'a>(
        &self,
...
impl<R: Runtime> ReadIceberg<R> {
    async fn plan_inner(
        ...
        Ok(PlannedTableFunction2 {
            ...
            named: named_inputs,
            function_impl: TableFunctionImpl2::Scan(Arc::new(IcebergDataTable {
