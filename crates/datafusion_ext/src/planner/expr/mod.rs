...
//     #[async_trait]
//     impl AsyncContextProvider for TestSchemaProvider {
//         async fn get_table_provider(&self, name: TableReference) -> Result<Arc<dyn TableSource>> {
...
//         async fn get_function_meta(&self, _name: &str) -> Option<Arc<ScalarUDF>> {
//             None
//         }

//         async fn get_aggregate_meta(&self, _name: &str) -> Option<Arc<AggregateUDF>> {
//             None
//         }

//         async fn get_variable_type(&self, _variable_names: &[String]) -> Option<DataType> {
//             None
//         }
...
//                     let sql_to_rel = SqlQueryPlanner::new(&schema_provider);
